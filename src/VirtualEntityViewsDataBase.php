...
class VirtualEntityViewsDataBase implements EntityHandlerInterface, EntityViewsDataInterface {
   ...
   *   The translation manager.
   */
  public function __construct(EntityTypeInterface $entity_type, VirtualEntityStorage $storage_controller, EntityManagerInterface $entity_manager, ModuleHandlerInterface $module_handler, TranslationInterface $translation_manager) {
